...
describe('favorite blog', () => {
  test('From a large list of blogs, the highest-rated one is returned', () => {
...
describe('Most Blogs', () => {
  test('Given a list of bloggers, the author with the most blog posts is returned', () => {
...
describe('Most Likes', () => {
  test('Given a list of bloggers, the author with the most liked posts is returned', () => {
